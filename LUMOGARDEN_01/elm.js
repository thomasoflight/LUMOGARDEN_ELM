...
var _user$project$Jars$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
...
var _user$project$Jars$Model = F2(
	function (a, b) {
		return {cardA: a, cardB: b};
	});
var _user$project$Jars$Step = F3(
	function (a, b, c) {
		return {description: a, completed: b, id: c};
	});
var _user$project$Jars$someSteps = {
	ctor: '::',
	_0: A3(_user$project$Jars$Step, 'A', true, 1),
	_1: {
		ctor: '::',
		_0: A3(_user$project$Jars$Step, 'B', false, 2),
		_1: {
			ctor: '::',
			_0: A3(_user$project$Jars$Step, 'C', false, 3),
			_1: {
				ctor: '::',
				_0: A3(_user$project$Jars$Step, 'D', false, 4),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Jars$Step, 'E', false, 5),
					_1: {
						ctor: '::',
						_0: A3(_user$project$Jars$Step, '...', false, 6),
						_1: {
							ctor: '::',
							_0: A3(_user$project$Jars$Step, '...', false, 7),
							_1: {
								ctor: '::',
								_0: A3(_user$project$Jars$Step, '...', false, 8),
								_1: {
									ctor: '::',
									_0: A3(_user$project$Jars$Step, '...', false, 9),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Jars$moreSteps = {
	ctor: '::',
	_0: A3(_user$project$Jars$Step, 'C', false, 10),
	_1: {
		ctor: '::',
		_0: A3(_user$project$Jars$Step, 'D', false, 11),
		_1: {ctor: '[]'}
	}
};
var _user$project$Jars$Card = F3(
	function (a, b, c) {
		return {title: a, steps: b, flaggedForComplete: c};
	});
var _user$project$Jars$cardA = A3(
	_user$project$Jars$Card,
	'C',
	_user$project$Jars$someSteps,
	{ctor: '[]'});
var _user$project$Jars$cardB = A3(
	_user$project$Jars$Card,
	'B',
	_user$project$Jars$moreSteps,
	{ctor: '[]'});
var _user$project$Jars$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	A2(_user$project$Jars$Model, _user$project$Jars$cardA, _user$project$Jars$cardB),
	{ctor: '[]'});
var _user$project$Jars$Rebloom = {ctor: 'Rebloom'};
var _user$project$Jars$ToggleComplete = F2(
	function (a, b) {
		return {ctor: 'ToggleComplete', _0: a, _1: b};
	});
var _user$project$Jars$Check = function (a) {
	return {ctor: 'Check', _0: a};
};
var _user$project$Jars$NoOp = {ctor: 'NoOp'};
var _user$project$Jars$BtmR = {ctor: 'BtmR'};
var _user$project$Jars$BtmC = {ctor: 'BtmC'};
var _user$project$Jars$BtmL = {ctor: 'BtmL'};
var _user$project$Jars$MidR = {ctor: 'MidR'};
var _user$project$Jars$MidL = {ctor: 'MidL'};
var _user$project$Jars$TopR = {ctor: 'TopR'};
var _user$project$Jars$TopC = {ctor: 'TopC'};
var _user$project$Jars$TopL = {ctor: 'TopL'};
var _user$project$Jars$LumoBlockHeaderCenter = {ctor: 'LumoBlockHeaderCenter'};
var _user$project$Jars$LumoBlockHeader = {ctor: 'LumoBlockHeader'};
var _user$project$Jars$LumoBlock = {ctor: 'LumoBlock'};
var _user$project$Jars$viewLumoBlockCenter = F2(
	function (coordinates, blockName) {
		var _p1 = coordinates;
		var x = _p1._0;
		var y = _p1._1;
		return _mdgriffith$style_elements$Element$cell(
				...
				content: A3(
					...
					},
					{
						...
						_0: A3(
							...
							_user$project$Jars$LumoBlockHeaderCenter,
							{
								ctor: '::',
...
var _user$project$Jars$LumoHeader = {ctor: 'LumoHeader'};
var _user$project$Jars$Title = {ctor: 'Title'};
var _user$project$Jars$BlocksContainer = {ctor: 'BlocksContainer'};
var _user$project$Jars$DebugFill = {ctor: 'DebugFill'};
var _user$project$Jars$None = {ctor: 'None'};
var _user$project$Jars$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		ctor: '::',
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_user$project$Jars$None,
			{ctor: '[]'}),
		_1: {
			ctor: '::',
			_0: A2(
				_mdgriffith$style_elements$Style$style,
				_user$project$Jars$Title,
				{
					ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_mdgriffith$style_elements$Style$style,
							_user$project$Jars$BlocksContainer,
							{ctor: '[]'}),
						_1: {
							ctor: '::',
							_0: A2(
								_mdgriffith$style_elements$Style$style,
								_user$project$Jars$LumoHeader,
								{
									ctor: '::',
									_0: _mdgriffith$style_elements$Style_Font$typeface(_user$project$Jars$header),
									_1: {
										ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_mdgriffith$style_elements$Style$style,
									_user$project$Jars$LumoBlockHeader,
									{
										ctor: '::',
...
var _user$project$Jars$viewHeader = A3(
	_mdgriffith$style_elements$Element$row,
	_user$project$Jars$None,
	{
		ctor: '::',
...
var _user$project$Jars$viewLumoBlock = F2(
	function (coordinates, blockName) {
		var _p2 = coordinates;
		var x = _p2._0;
		var y = _p2._1;
						...
						_0: A3(
							...
							},
							{
								...
								_0: A3(
									...
									_user$project$Jars$None,
									{ctor: '[]'},
									_mdgriffith$style_elements$Element$text(blockName)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					})
...
var _user$project$Jars$viewBlocks = F2(
		...
		return A3(
			...
			},
			{
				...
				cells: {
					ctor: '::',
					_0: A2(
						_user$project$Jars$viewLumoBlock,
						{ctor: '_Tuple2', _0: 0, _1: 0},
						_elm_lang$core$Basics$toString(model.cardA.title)),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Jars$viewLumoBlock,
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(
										_user$project$Jars$viewLumoBlockCenter,
...
var _user$project$Jars$view = function (model) {
	var originWidth = 620;
	return A2(
		_mdgriffith$style_elements$Element$layout,
		_user$project$Jars$stylesheet,
		A3(
			_mdgriffith$style_elements$Element$column,
			_user$project$Jars$None,
			{ctor: '[]'},
			{
				...
				_0: A3(
					...
					A3(
						...
						{
							ctor: '::',
							_0: _user$project$Jars$viewHeader,
							_1: {
								ctor: '::',
								_0: A2(_user$project$Jars$viewBlocks, model, originWidth),
								_1: {ctor: '[]'}
							}
						})),
				_1: {ctor: '[]'}
...
var _user$project$Jars$main = _elm_lang$html$Html$program(
	{
		init: _user$project$Jars$init,
		update: _user$project$Jars$update,
		view: _user$project$Jars$view,
...
var Elm = {};
Elm['Jars'] = Elm['Jars'] || {};
if (typeof _user$project$Jars$main !== 'undefined') {
    _user$project$Jars$main(Elm['Jars'], 'Jars', undefined);
}
